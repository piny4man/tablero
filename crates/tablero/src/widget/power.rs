...
mod tests {
    use crate::render::{Bounds, RenderContext};
    use crate::widget::{ClickButton, Command, LaunchSpec, Widget};
    ...
    fn left_and_right_clicks_run_their_configured_programs() {
        let left = LaunchSpec::program_only("wlogout");
        let right = LaunchSpec::program_only("hyprlock");
    ...
    fn unconfigured_or_outside_clicks_are_ignored() {
        ...
        let widget = widget.with_on_click(Some(LaunchSpec::program_only("wlogout")));
