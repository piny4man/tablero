...
//! [`Msg::Workspaces`]; [`WorkspaceWidget`] renders it,
...
/// a visible change only when its internal view actually differs — a repeated
...
impl WorkspaceWidget {
    ...
    /// first [`Msg::Workspaces`]. It shows the global
