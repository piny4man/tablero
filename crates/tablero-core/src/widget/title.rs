...
//! through [`Msg::ActiveWindow`](super::Msg::ActiveWindow); [`TitleWidget`]
...
//! [`DEFAULT_MAX_LENGTH`](DEFAULT_MAX_LENGTH) chars by default; `0` disables
...
impl TitleWidget {
    ...
    /// matching [`Msg::ActiveWindow`](super::Msg::ActiveWindow) and carrying
    ...
    /// any [`Msg::ActiveWindow`](super::Msg::ActiveWindow) regardless of
